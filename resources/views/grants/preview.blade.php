<x-slim-layout>
    ...
    <x-alert color="warning" class="d-flex align-items-center d-print-none mt-5">
        ...
        <div>{!! __('If you have any questions, please contact <a href="mailto::email" class="alert-link">:name</a>.', ['name' => config('app.support'), 'email' => config('app.email')]) !!}</div>
    </x-alert>
</x-slim-layout>
