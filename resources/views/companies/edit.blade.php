<x-base-layout>
    <form action="{{ route('companies.update', $company) }}" method="POST" accept-charset="UTF-8" autocomplete="off" autocapitalize="off">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            <div class="form-floating">
                <input type="text" class="form-control" name="name" id="name" placeholder="{{ __('e.g. Example Company GmbH') }}" maxlength="255" value="{{ old('name', $company->name) }}" autocomplete="off" autocapitalize="off" required>
        ...
        <div class="row">
            <div class="col-4">
                <div class="form-floating mb-3">
                    <input type="date" class="form-control" name="founded_at" id="founded_at" placeholder="" value="{{ optional(old('founded_at', $company->founded_at))->format('Y-m-d') }}">
                    <label for="founded_at">{{ __('Founded at') }}</label>
                </div>
            </div>
            <div class="col-4">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="register_court" id="register_court" list="register_courts" placeholder="{{ __('e.g. Amtsgericht Aachen') }}" maxlength="255" value="{{ old('register_court', $company->register_court) }}" autocomplete="off" autocapitalize="off" spellcheck="false">
                    <label for="register_court">{{ __('Register court') }}</label>
                </div>
            </div>
            <div class="col-4">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="register_number" id="register_number" placeholder="{{ __('e.g. HRB 12345') }}" maxlength="100" value="{{ old('register_number', $company->register_number) }}" autocomplete="off" autocapitalize="off" spellcheck="false">
        ...
        <div id="contacts">
            @foreach($company->contacts as $contact)
                <div class="row mt-3">
                    <div class="col-4">
                        <div class="form-floating">
                            <input type="text" class="form-control" name="last_names[]" id="last_name" placeholder="{{ __('Last name') }}" maxlength="100" value="{{ $contact->last_name }}" autocomplete="off" spellcheck="false" required>
                            <label for="last_name">{{ __('Last name') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-floating">
                            <input type="text" class="form-control" name="first_names[]" id="first_name" placeholder="{{ __('First name') }}" maxlength="100" value="{{ $contact->first_name }}" autocomplete="off" spellcheck="false" required>
                            <label for="first_name">{{ __('First name') }}</label>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="form-floating">
                            <input type="email" class="form-control" name="emails[]" id="email" placeholder="{{ __('e.g. mail@example.com') }}" maxlength="255" value="{{ $contact->email }}" autocomplete="off" required>
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('companies.show', $company) }}" class="btn btn-outline-secondary">{{ __('Cancel') }}</a>
        </div>
    </form>
